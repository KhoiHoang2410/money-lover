...
> **Status: superseded by [ADR-0013](0013-canonical-backend-thin-clients.md).** The project moved to a canonical Rails backend with iOS and web clients. The reasoning below is retained for historical context.
